...
CalendarDateSelect.prototype = {
    ...
    initHeaderDiv : function() {
        ...
        this.next_month_button = header_div.build("a", { innerHTML: "<img src='../images/mtg/next.gif' border='0'>", href:"#", onclick:function () {
        ...
        this.prev_month_button = header_div.build("a", { innerHTML: "<img src='../images/mtg/prev.gif' border='0'>", href:"#", onclick:function () {
            this.navMonth(this.date.getMonth() - 1);
            return false;
