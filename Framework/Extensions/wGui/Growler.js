...
Growler = (function(){
	...
	return Class.create({
		...
		,warn: function(msg, options){
			return specialNotice(this.growler, msg, options, "Atención!", "#F6BD6F", "#000");
		}
		,error: function(msg, options){
			return specialNotice(this.growler, msg, options, "Error!", "#F66F82", "#000");
		}
		,info: function(msg, options){
			return specialNotice(this.growler, msg, options, "Información", "#BBF66F", "#000");
		}
