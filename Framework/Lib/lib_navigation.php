...
class Geography {
	...
	public static function getDistanceLL($coord1,$coord2) {
		$o=new Geography();
		$x=explode(",",$coord1);
		$y=explode(",",$coord2);
		$latitude1=$o->convertToDecimal($o->convertLatToDMS($x[0]));
		$longitude1=$o->convertToDecimal($o->convertLongToDMS($x[1]));

		$latitude2=$o->convertToDecimal($o->convertLatToDMS($y[0]));
		$longitude2=$o->convertToDecimal($o->convertLongToDMS($y[1]));


		return $o->mToKm($o->getDistance($latitude1, $longitude1, $latitude2, $longitude2));
