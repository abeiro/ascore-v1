...
*/
class avSelectTree extends CoreWidget {
	...
	*/
	...
	function avSelectPrintTree($name,$module,$class,$cclass,$show,$current,$method=''){
	
		global $SYS;
		
		if ($_SESSION["GLOBAL"]["zoom"]=="popup") {
			return $this->avSelectWPrintTree($name,$module,$class,$show,$current,$method);
		}
		...
		<iframe src=\"{$SYS["ROOT"]}/Framework/Extensions/Tree/Tree.php?module=$module&class=$class&show=$show&current=$current&name=$name&cclass=$cclass&method=$cmethod\" id=\"wFrame$class$name\" width=\"400\" name=\"wFrame$class$name\"  height=\"300\"  border=\"0\" style=\"display:none;position:absolute;\" ></iframe>";
		return $res;
	}
	...
	*/
	...
	function show($name,$module,$class,$show,$current,$method=''){
		return avSelectPrintTree($name,$module,$class,$show,$current,$method);
	}
