...
?>
	...
	<p align="justify">Bienvenido al sistema de instalaci�n automatizado de ASCore.</p>
	<p align="justify">Recuerde que una vez instalado el sistema deber� de borrar el fichero <strong>install.php</strong> de su servidor.</p>
...
?>
	...
	<p align="justify">Se ha generado un fichero .htaccess con la configuraci�n especificada anteriormente</p>
	<p align="justify">Ahora necesito crear la base de datos inicial, para ello necesitamos la contrase�a de administrador de MySQL. El usuario administrador usualmente es "root" en sistemas Linux</p>
	...
	<div class="cell2">Contrase�a administrador MySQL:</div> <input type="password" name="DBAPASS" value="" size="15"><br clear="all" />

	<p align="justify">Note que puede crear el usuario y la base de datos "a mano". Si escoge esta opci�n, marque la siguiente casilla y s�lo especifique la base de datos y el usuario de la misma para este proyecto</p>

	<div class="cell2">S�, ya he creado la base de datos</div> <input type="checkbox" name="ALREADYCREATED" size="15"><br clear="all" />	
	...
	<div class="cell2">Contrase�a del usuario BBDD para este proyecto (solo necesario si el usuario ya existe):</div> <input type="password" name="DBDBPASS" value="" size="15"><br clear="all" />
...
<?php
	if (empty($_POST["ALREADYCREATED"])) {
			...
			echo "* Creando usuario....(contrase�a generada)";
	...
	echo "* Creando fichero de configuraci�n..";
...
?>
	<p>Por favor, revise el fichero de configuraci�n <strong>Framework/conf.php</strong></p>

	<p>Ahora necesitamos hacer una importaci�n inicial de la base de datos. Puede que quiera saltarse este paso si solo est� reconfigurando una instalaci�n existente o simplemente lo va a hacer por su cuenta</strong></p>

	<form method="post">
	
	<div class="cell2">S�, deseo hacer la imporaci�n inicial</div><input type="checkbox" name="IMPORTPLEASE" size="15"><br clear="all" />	
        <br clear="all" />
